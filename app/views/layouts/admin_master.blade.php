...
<html lang="en">
	<head>
		<meta charset="utf-8">
		  ...
		  <!-- Styles -->
		  <link rel="stylesheet" href="party_soiree_template/bootstrap3/multipage/bootstrap3/multipage/css/font-awesome.min.css">
		  <link rel="stylesheet" href="party_soiree_template/bootstrap3/multipage/bootstrap3/multipage/css/animate.css">
		  <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'>

		  <link rel="stylesheet" href="party_soiree_template/bootstrap3/multipage/bootstrap3/multipage/css/bootstrap.min.css">
		  <link rel="stylesheet" href="party_soiree_template/bootstrap3/multipage/bootstrap3/multipage/css/main.css">
		  <link rel="stylesheet" href="party_soiree_template/bootstrap3/multipage/bootstrap3/multipage/css/custom-styles.css">

		  <script src="party_soiree_template/bootstrap3/multipage/bootstrap3/multipage/js/modernizr-2.6.2-respond-1.1.0.min.js"></script>

		  <!-- Fav and touch icons -->
		  <link rel="apple-touch-icon-precomposed" sizes="144x144" href="party_soiree_template/bootstrap3/multipage/bootstrap3/multipage/apple-touch-icon-144-precomposed.png">
		  <link rel="apple-touch-icon-precomposed" sizes="114x114" href="party_soiree_template/bootstrap3/multipage/bootstrap3/multipage/apple-touch-icon-114-precomposed.png">
		  <link rel="apple-touch-icon-precomposed" sizes="72x72" href="party_soiree_template/bootstrap3/multipage/bootstrap3/multipage/apple-touch-icon-72-precomposed.png">
		  <link rel="apple-touch-icon-precomposed" href="party_soiree_template/bootstrap3/multipage/bootstrap3/multipage/apple-touch-icon-57-precomposed.png">
		  <link rel="shortcut icon" href="party_soiree_template/bootstrap3/multipage/bootstrap3/multipage/favicon.png">
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
             <li><a href="/admin_users"><span class="active" id="contact">USER MANAGEMENT</span></a></li>
             <li><a href="/admin_admin"><span class="cp-nav-link" id="clients">ADMIN MANAGEMENT</span></a></li>
             <li class="active">
...
<!-- Javascript
    ...
    <script>window.jQuery || document.write('<script src="party_soiree_template/bootstrap3/multipage/bootstrap3/multipage/js/jquery-1.10.1.min.js"><\/script>')</script>
